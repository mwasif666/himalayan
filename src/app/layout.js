...
export const metadata = {
  title: "Himalayan Salt Company - Pure & Natural Products",
  description:
    "Discover premium Himalayan salt products including edible salt, lamps, and wellness items. 100% natural, pure, and rich in minerals, sourced from the Himalayan mountains of Pakistan.",
};
